...
<div class="container">
    ...
    <div class="card">
        ...
        <form>
            ...
            <div class="input-container"><input type="text" required/><label>전화번호</label>
                <div class="bar"></div>
            </div>
            <div class="button-container"><button type="button" onclick="location.href='comIdFrm'" style=width:240px;><span>ID 찾기</span></button></div>
        </form>
    </div>
</div>
</div>	
