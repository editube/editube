		...
		<div class="myEPageCashIncontent">	
			...
			<c:forEach var="cashItem" items="${cashList}">
				...
				<c:if test="${cashItem.ca_type == 1}">
					<div class="cashRe">
					<p>${cashItem.ca_incash}원을 충전하였습니다.</p>
					<p></p>
					</div>
				</c:if>
				...
				<c:if test="${cashItem.ca_type == 2}">
					<div class="cashRe">
					<p>${cashItem.ca_outcash}원을 환전하였습니다.</p>
					<p></p>
					</div>
				</c:if>
				...
				<c:if test="${cashItem.ca_type == 3}">
					<div class="cashRe">
					<p>${cashItem.ca_targetnickname}님에게 ${cashItem.ca_outcash}원을 지급하였습니다.</p>
					<p></p>
					</div>
				</c:if>
				...
				<c:if test="${cashItem.ca_type == 4}">
					<div class="cashRe">
					<p>
					${cashItem.ca_targetnickname}님에게 ${cashItem.ca_incash}원을 받았습니다.
					</p>
					<p></p>
					</div>
				</c:if>
